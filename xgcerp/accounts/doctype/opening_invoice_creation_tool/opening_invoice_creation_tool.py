...
class OpeningInvoiceCreationTool(Document):
	...
	if TYPE_CHECKING:
		...
		from xgcerp.accounts.doctype.opening_invoice_creation_tool_item.opening_invoice_creation_tool_item import (
		...
		invoice = frappe._dict(
			{
				...
				"update_stock": 0,  # important: https://github.com/frappe/xgcerp/pull/23559
