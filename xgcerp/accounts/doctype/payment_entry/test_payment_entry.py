...
from xgcerp.accounts.doctype.payment_entry.payment_entry import (
...
from xgcerp.accounts.doctype.sales_invoice.test_sales_invoice import (
	create_sales_invoice,
	create_sales_invoice_against_cost_center,
)
from xgcerp.selling.doctype.sales_order.test_sales_order import make_sales_order
from xgcerp.setup.doctype.employee.test_employee import make_employee
...
class TestPaymentEntry(FrappeTestCase):
	...
	def test_payment_entry_retrieves_last_exchange_rate(self):
		from xgcerp.setup.doctype.currency_exchange.test_currency_exchange import (
			save_new_records,
			test_records,
		)
