...
from xgcerp.accounts.utils import sync_auto_reconcile_config
from xgcerp.stock.utils import check_pending_reposting
...
class AccountsSettings(Document):
	...
	def drop_ar_sql_procedures(self):
		from xgcerp.accounts.report.accounts_receivable.accounts_receivable import InitSQLProceduresForAR
