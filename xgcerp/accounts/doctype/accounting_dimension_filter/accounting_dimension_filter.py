...
class AccountingDimensionFilter(Document):
	...
	if TYPE_CHECKING:
		...
		from xgcerp.accounts.doctype.allowed_dimension.allowed_dimension import AllowedDimension
		from xgcerp.accounts.doctype.applicable_on_account.applicable_on_account import ApplicableOnAccount
