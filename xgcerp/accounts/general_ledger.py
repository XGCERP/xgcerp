...
from xgcerp.accounts.doctype.accounting_dimension_filter.accounting_dimension_filter import (
	get_dimension_filter_map,
)
from xgcerp.accounts.doctype.accounting_period.accounting_period import ClosedAccountingPeriod
from xgcerp.accounts.doctype.budget.budget import validate_expense_against_budget
from xgcerp.accounts.utils import create_payment_ledger_entry, is_immutable_ledger_enabled
from xgcerp.exceptions import InvalidAccountDimensionError, MandatoryAccountDimensionError
...
def merge_similar_entries(gl_map, precision=None):
	...
	company = gl_map[0].company if gl_map else xgcerp.get_default_company()
