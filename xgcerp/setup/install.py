...
import xgcerp
from xgcerp.setup.default_energy_point_rules import get_default_energy_point_rules
from xgcerp.setup.doctype.incoterm.incoterm import create_incoterms

from .default_success_action import get_default_success_action

default_mail_footer = """<div style="padding: 7px; text-align: right; color: #888"><small>Sent via
	<a style="color: #888" href="http://frappe.io/xgcerp">XGCerp</a></div>"""
...
def check_frappe_version():
	...
	xgcerp_version = major_version(xgcerp.__version__)

	if frappe_version == xgcerp_version:
		return

	click.secho(
		f"You're attempting to install XGCerp version {xgcerp_version} with Frappe version {frappe_version}. "
...
def add_standard_navbar_items():
	...
	xgcerp_navbar_items = [
		...
		},
		{
			...
			"item_type": "Route",
			"route": "https://github.com/frappe/xgcerp/issues",
			"is_standard": 1,
		},
	]
	...
	for item in xgcerp_navbar_items:
