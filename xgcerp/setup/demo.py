...
def setup_demo_data():
	...
	capture("demo_data_creation_started", "xgcerp")
	try:
		...
		capture("demo_data_creation_failed", "xgcerp", properties={"exception": frappe.get_traceback()})
		raise
	capture("demo_data_creation_completed", "xgcerp")
...
def clear_demo_data():
	...
	capture("demo_data_erased", "xgcerp")
	try:
...
def make_transactions(company):
	...
	from xgcerp.accounts.utils import FiscalYearError
