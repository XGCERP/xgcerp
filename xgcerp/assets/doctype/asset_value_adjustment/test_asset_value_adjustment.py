...
from xgcerp.assets.doctype.asset.test_asset import create_asset_data
from xgcerp.assets.doctype.asset_depreciation_schedule.asset_depreciation_schedule import (
	get_asset_depr_schedule_doc,
)
from xgcerp.assets.doctype.asset_repair.test_asset_repair import create_asset_repair
