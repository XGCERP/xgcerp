...
import xgcerp
from xgcerp.assets.doctype.asset.asset import get_asset_value_after_depreciation
...
from xgcerp.stock.utils import get_incoming_rate
...
class AssetCapitalization(StockController):
	...
	if TYPE_CHECKING:
		...
		from xgcerp.assets.doctype.asset_capitalization_asset_item.asset_capitalization_asset_item import (
			AssetCapitalizationAssetItem,
		)
		from xgcerp.assets.doctype.asset_capitalization_service_item.asset_capitalization_service_item import (
			AssetCapitalizationServiceItem,
		)
		from xgcerp.assets.doctype.asset_capitalization_stock_item.asset_capitalization_stock_item import (
	...
	def validate_item(self, item):
		from xgcerp.stock.doctype.item.item import validate_end_of_life
		...
		for item_row in self.stock_items:
			...
			if sle_list:
				for sle in sle_list:
					...
					if xgcerp.is_perpetual_inventory_enabled(self.company):
