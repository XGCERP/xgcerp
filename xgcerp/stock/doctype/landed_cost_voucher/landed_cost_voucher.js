...
xgcerp.landed_cost_taxes_and_charges.setup_triggers("Landed Cost Voucher");
xgcerp.stock.LandedCostVoucher = class LandedCostVoucher extends xgcerp.stock.StockController {
	setup() {
		var me = this;
...
cur_frm.script_manager.make(xgcerp.stock.LandedCostVoucher);
