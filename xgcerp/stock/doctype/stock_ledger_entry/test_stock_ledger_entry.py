...
from xgcerp.accounts.doctype.gl_entry.gl_entry import rename_gle_sle_docs
...
from xgcerp.stock.doctype.stock_ledger_entry.stock_ledger_entry import BackDatedStockTransaction
...
class TestStockLedgerEntry(FrappeTestCase, StockTestMixin):
	...
	def test_tie_breaking(self):
		from xgcerp.stock.doctype.repost_item_valuation.repost_item_valuation import repost_entries
	...
	def test_negative_qty_with_precision(self):
		...
		from xgcerp.stock.utils import get_stock_balance
