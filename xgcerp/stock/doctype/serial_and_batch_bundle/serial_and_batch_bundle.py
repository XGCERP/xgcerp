...
from xgcerp.stock.valuation import FIFOValuation
...
class SerialandBatchBundle(Document):
	...
	if TYPE_CHECKING:
		...
		from xgcerp.stock.doctype.serial_and_batch_entry.serial_and_batch_entry import SerialandBatchEntry
...
def get_reserved_serial_nos_for_pos(kwargs):
	from xgcerp.controllers.sales_and_purchase_return import get_returned_serial_nos
