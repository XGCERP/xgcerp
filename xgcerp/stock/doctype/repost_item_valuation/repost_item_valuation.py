...
import xgcerp
from xgcerp.accounts.general_ledger import validate_accounting_period
from xgcerp.accounts.utils import get_future_stock_vouchers, repost_gle_for_stock_vouchers
from xgcerp.stock.stock_ledger import (
...
def repost_gl_entries(doc):
	if not cint(xgcerp.is_perpetual_inventory_enabled(doc.company)):
		return
