...
def task(doc_name, from_doctype, to_doctype):
	from xgcerp.accounts.doctype.payment_entry import payment_entry
	from xgcerp.accounts.doctype.purchase_invoice import purchase_invoice
	from xgcerp.accounts.doctype.sales_invoice import sales_invoice
	from xgcerp.buying.doctype.purchase_order import purchase_order
	from xgcerp.buying.doctype.supplier_quotation import supplier_quotation
	from xgcerp.selling.doctype.quotation import quotation
	from xgcerp.selling.doctype.sales_order import sales_order
	from xgcerp.stock.doctype.delivery_note import delivery_note
	from xgcerp.stock.doctype.purchase_receipt import purchase_receipt
