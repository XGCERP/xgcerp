...
class Prospect(CRMNote):
	...
	if TYPE_CHECKING:
		...
		from xgcerp.crm.doctype.prospect_lead.prospect_lead import ProspectLead
		from xgcerp.crm.doctype.prospect_opportunity.prospect_opportunity import ProspectOpportunity
