...
from xgcerp.controllers.subcontracting_controller import SubcontractingController
...
from xgcerp.stock.get_item_details import get_default_cost_center, get_default_expense_account
...
class SubcontractingReceipt(SubcontractingController):
	...
	if TYPE_CHECKING:
		...
		from xgcerp.subcontracting.doctype.subcontracting_receipt_item.subcontracting_receipt_item import (
			SubcontractingReceiptItem,
		)
		from xgcerp.subcontracting.doctype.subcontracting_receipt_supplied_item.subcontracting_receipt_supplied_item import (
	...
	def get_gl_entries(self, warehouse_account=None):
		...
		if not xgcerp.is_perpetual_inventory_enabled(self.company):
			return []
