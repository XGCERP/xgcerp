...
from xgcerp.accounts.party import get_due_date_from_template
...
from xgcerp.controllers.accounts_controller import InvalidQtyError, update_child_qty_rate
from xgcerp.manufacturing.doctype.blanket_order.test_blanket_order import make_blanket_order
...
class TestPurchaseOrder(FrappeTestCase):
	...
	def test_purchase_order_invoice_receipt_workflow(self):
		from xgcerp.accounts.doctype.purchase_invoice.purchase_invoice import make_purchase_receipt
	...
	def test_warehouse_company_validation(self):
		from xgcerp.stock.utils import InvalidWarehouseCompany

		po = create_purchase_order(company="_Test Company 1", do_not_save=True)
		self.assertRaises(InvalidWarehouseCompany, po.insert)

	def test_uom_integer_validation(self):
		from xgcerp.utilities.transaction_base import UOMMustBeIntegerError
	...
	def test_internal_transfer_flow(self):
		...
		from xgcerp.selling.doctype.sales_order.sales_order import (
			make_delivery_note,
			make_sales_invoice,
		)
	...
	def test_update_items_for_subcontracting_purchase_order(self):
		from xgcerp.controllers.tests.test_subcontracting_controller import (
	...
	def test_new_sc_flow(self):
		from xgcerp.buying.doctype.purchase_order.purchase_order import make_subcontracting_order
