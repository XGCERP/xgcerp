...
from xgcerp.buying.doctype.purchase_order.test_purchase_order import prepare_data_for_internal_transfer
...
class TestAccountsController(FrappeTestCase):
	...
	def test_party_billing_and_shipping_address(self):
		from xgcerp.crm.doctype.prospect.test_prospect import make_address
