...
frappe.ui.form.on("Customer", {
	setup: function (frm) {
		frm.make_methods = {
			Quotation: () =>
				frappe.model.open_mapped_doc({
					method: "xgcerp.selling.doctype.customer.customer.make_quotation",
					frm: cur_frm,
				}),
			Opportunity: () =>
				frappe.model.open_mapped_doc({
					method: "xgcerp.selling.doctype.customer.customer.make_opportunity",
					frm: cur_frm,
				}),
		...
		frm.set_query("customer_primary_contact", function (doc) {
			return {
				query: "xgcerp.selling.doctype.customer.customer.get_customer_primary_contact",
				filters: {
					customer: doc.name,
				},
			};
