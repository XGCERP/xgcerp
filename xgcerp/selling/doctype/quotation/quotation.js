...
xgcerp.accounts.taxes.setup_tax_validations("Sales Taxes and Charges Template");
xgcerp.accounts.taxes.setup_tax_filters("Sales Taxes and Charges");
xgcerp.pre_sales.set_as_lost("Quotation");
...
xgcerp.selling.QuotationController = class QuotationController extends xgcerp.selling.SellingController {
	onload(doc, dt, dn) {
	...
	set_dynamic_field_label() {
		if (this.frm.doc.quotation_to == "Customer") {
			...
			this.frm.fields_dict.party_name.get_query = function () {
				return { query: "xgcerp.controllers.queries.lead_query" };
			};
	...
	get_lead_details() {
		...
		frappe.call({
			method: "xgcerp.crm.doctype.lead.lead.get_lead_details",
			args: {
...
cur_frm.script_manager.make(xgcerp.selling.QuotationController);
