...
xgcerp.accounts.bank_reconciliation.NumberCardManager = class NumberCardManager {
	constructor(opts) {
	...
	make_cards() {
		...
		chart_data.forEach((summary) => {
			let number_card = new xgcerp.accounts.NumberCard(summary);
...
xgcerp.accounts.NumberCard = class NumberCard {
	constructor(options) {
