frappe.provide("xgcerp.timesheet");

xgcerp.timesheet.timer = function (frm, row, timestamp = 0) {
	...
	xgcerp.timesheet.control_timer(frm, dialog, row, timestamp);
	dialog.show();
};

xgcerp.timesheet.control_timer = function (frm, dialog, row, timestamp = 0) {
