...
from xgcerp import get_default_company
from xgcerp.controllers.queries import get_filters_cond
from xgcerp.controllers.website_list_for_contact import get_customers_suppliers
from xgcerp.setup.doctype.holiday_list.holiday_list import is_holiday
...
class Project(Document):
	...
	if TYPE_CHECKING:
		...
		from xgcerp.projects.doctype.project_user.project_user import ProjectUser
