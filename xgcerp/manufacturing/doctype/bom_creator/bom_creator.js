...
frappe.ui.form.on("BOM Creator", {
	...
	make_new_entry(frm) {
		...
		dialog.fields_dict.item_code.get_query = "xgcerp.controllers.queries.item_query";
		dialog.show();
	},
...
xgcerp.bom.BomConfigurator = class BomConfigurator extends xgcerp.TransactionController {
	conversion_rate(doc) {
...
extend_cscript(cur_frm.cscript, new xgcerp.bom.BomConfigurator({ frm: cur_frm }));
