...
from xgcerp.manufacturing.doctype.bom.bom import get_children as get_bom_children
from xgcerp.manufacturing.doctype.bom.bom import validate_bom_no
from xgcerp.manufacturing.doctype.work_order.work_order import get_item_details
from xgcerp.setup.doctype.item_group.item_group import get_item_group_defaults
from xgcerp.stock.get_item_details import get_conversion_factor
from xgcerp.stock.utils import get_or_make_bin
from xgcerp.utilities.transaction_base import validate_uom_is_integer
...
class ProductionPlan(Document):
	...
	if TYPE_CHECKING:
		...
		from xgcerp.manufacturing.doctype.material_request_plan_item.material_request_plan_item import (
			MaterialRequestPlanItem,
		)
		from xgcerp.manufacturing.doctype.production_plan_item.production_plan_item import ProductionPlanItem
		from xgcerp.manufacturing.doctype.production_plan_item_reference.production_plan_item_reference import (
			ProductionPlanItemReference,
		)
		from xgcerp.manufacturing.doctype.production_plan_material_request.production_plan_material_request import (
			ProductionPlanMaterialRequest,
		)
		from xgcerp.manufacturing.doctype.production_plan_material_request_warehouse.production_plan_material_request_warehouse import (
			ProductionPlanMaterialRequestWarehouse,
		)
		from xgcerp.manufacturing.doctype.production_plan_sales_order.production_plan_sales_order import (
			ProductionPlanSalesOrder,
		)
		from xgcerp.manufacturing.doctype.production_plan_sub_assembly_item.production_plan_sub_assembly_item import (
	...
	def make_work_order(self):
		from xgcerp.manufacturing.doctype.work_order.work_order import get_default_warehouse
	...
	def create_work_order(self, item):
		from xgcerp.manufacturing.doctype.work_order.work_order import OverProductionError
...
def get_materials_from_other_locations(item, warehouses, new_mr_items, company):
	from xgcerp.stock.doctype.pick_list.pick_list import get_available_item_locations
...
def get_reserved_qty_for_production_plan(item_code, warehouse):
	from xgcerp.manufacturing.doctype.work_order.work_order import get_reserved_qty_for_production
