- Enhancements
	...
	- Other Features
		...
		- A free marketplace where any AXERP user can list their products and be discovered by thousands of other companies using AXERP
...
- Changes have been made to ensure AXERP is compatible with Python 3
