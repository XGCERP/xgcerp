- Enhancements
	...
	- Other Features
		...
		- A free marketplace where any XGCERP user can list their products and be discovered by thousands of other companies using XGCERP
...
- Changes have been made to ensure XGCERP is compatible with Python 3
