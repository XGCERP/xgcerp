...
class TestDeferredRevenueAndExpense(AXERPTestSuite, AccountsTestMixin):
	maxDiff = None
	...
	@AXERPTestSuite.change_settings("Accounts Settings", {"book_deferred_entries_based_on": "Months"})
