...
class TestDeferredRevenueAndExpense(XGCERPTestSuite, AccountsTestMixin):
	maxDiff = None
	...
	@XGCERPTestSuite.change_settings("Accounts Settings", {"book_deferred_entries_based_on": "Months"})
